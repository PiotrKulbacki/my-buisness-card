...
const icons: Record<SocialKey, { label: string; path: string }> = {
  ...
  tiktok: {
    label: "TikTok",
    path: "M19.6 8.6a6.6 6.6 0 0 1-3.9-1.3v7.4a5.9 5.9 0 1 1-5.1-5.8v3a2.9 2.9 0 1 0 2.1 2.8V2.5h3a3.6 3.6 0 0 0 .1 1 3.7 3.7 0 0 0 2.3 2.6 3.7 3.7 0 0 0 1.5.3v2.2z",
  },
  youtube: {
    label: "YouTube",
